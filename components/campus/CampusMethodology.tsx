    ...
    <section className="py-24 bg-gray-900/50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Card 1 */}
          <div className="bg-brand-dark p-8 border-t-4 border-brand-green hover:-translate-y-2 transition-transform duration-300 shadow-xl group">
            <Dumbbell className="w-12 h-12 text-brand-green mb-6 group-hover:scale-110 transition-transform" />
          ...
          {/* Card 2 */}
          <div className="bg-brand-dark p-8 border-t-4 border-brand-green hover:-translate-y-2 transition-transform duration-300 shadow-xl group">
            <Brain className="w-12 h-12 text-brand-green mb-6 group-hover:scale-110 transition-transform" />
          ...
          {/* Card 3 */}
          <div className="bg-brand-dark p-8 border-t-4 border-brand-green hover:-translate-y-2 transition-transform duration-300 shadow-xl group">
            <Heart className="w-12 h-12 text-brand-green mb-6 group-hover:scale-110 transition-transform" />
