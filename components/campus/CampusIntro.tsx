      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        <div>
          <h2 className="text-3xl md:text-5xl font-black uppercase mb-8 leading-tight text-white">
            Entendiendo el <span className="text-brand-green">Rendimiento</span>
          </h2>
          <div className="space-y-6 text-gray-400 text-lg font-light leading-relaxed text-justify">
            ...
            <p>
              Como jugadora profesional y dietista deportiva, he entendido que el rendimiento va mucho más allá del entrenamiento en pista. Se compone de <span className="text-brand-green">cuerpo, mente, hábitos, valores y sacrificio</span>.
            </p>
            <p className="border-l-2 border-brand-green pl-4 italic text-white">
        ...
        <div className="relative">
          <div className="absolute inset-0 bg-brand-green/20 transform rotate-3 rounded-sm z-0"></div>
          <img 
