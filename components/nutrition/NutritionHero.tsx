...
export const NutritionHero: React.FC = () => {
  return (
    <section className="relative py-20 bg-brand-light overflow-hidden">
      <div className="absolute top-0 right-0 w-1/3 h-full bg-brand-green/10 transform skew-x-12 translate-x-20"></div>
      
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        <span className="text-brand-green font-bold tracking-[0.3em] text-xs uppercase block mb-4">
        ...
        <div className="h-1 w-20 bg-brand-green mx-auto mb-10"></div>
