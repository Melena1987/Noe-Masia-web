    ...
    <header id={id} className="relative h-screen w-full overflow-hidden flex flex-col justify-end bg-gray-900">
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden">
        ...
        <img 
          ...
          className="absolute inset-0 w-full h-[120%] object-cover object-[center_20%] z-0 will-change-transform"
          style={{ 
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-brand-dark via-transparent to-black/20 z-0"></div>
      </div>

      {/* Content */}
      <div className="relative z-10 w-full pb-24 md:pb-32 px-6 md:px-12 max-w-7xl mx-auto">
      ...
      {/* Scroll Indicator */}
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce-slow z-20 opacity-80 mix-blend-overlay">
        <a href="#about" className="text-white hover:text-brand-orange transition-colors duration-300">
