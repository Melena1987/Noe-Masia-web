...
export const Nutrition: React.FC<SectionProps> = ({ id }) => {
  return (
    <section id={id} className="py-24 md:py-32 bg-gray-50 text-brand-dark relative">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-12 gap-12 items-center">
          
          {/* Visual Side */}
          <div className="md:col-span-5 relative order-2 md:order-1">
             <div className="absolute top-4 left-4 w-full h-full border-2 border-brand-green z-0 hidden md:block"></div>
          ...
          <div className="md:col-span-7 order-1 md:order-2">
            <span className="text-brand-green uppercase tracking-[0.2em] font-bold text-sm mb-4 block">
              Sports Dietitian
            </span>
            ...
            <p className="text-gray-600 text-lg mb-8 leading-relaxed font-light border-l-4 border-brand-green pl-6">
